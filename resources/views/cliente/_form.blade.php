            ...
            <div class="col-md-4 text-center">
                <div class="position-relative">
                    @if(isset($cliente) && $cliente->foto)
                        <img id="fotoPreview" src="{{ asset('storage/' . $cliente->foto) }}" alt="Foto de perfil" style="width: 180px; height: 180px; border-radius: 10px; object-fit: cover; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                    @else
